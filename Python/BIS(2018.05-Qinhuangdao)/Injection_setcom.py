...
#############################################################################
        ...
        self.parity_comboBox.addItem(_fromUtf8("None"))
        self.parity_comboBox.addItem(_fromUtf8("Odd"))
        self.parity_comboBox.addItem(_fromUtf8("Even"))
        self.parity_comboBox.addItem(_fromUtf8("Mark"))
        self.parity_comboBox.addItem(_fromUtf8("Sapce"))
